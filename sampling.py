...
class MixedPrioritizedSampler(Sampler):
    ...
    def __init__(self, labels, balance_scale=1.0, fixed_scale=1.0,
                 lam=1, epochs=30, cycle=0, nroot=2, manual_only=True,
                 rescale=True, root_decay=None, decay_gap=30, ptype='score',
                 alpha=1.0):
        """
        """
        self.dataset = labels
